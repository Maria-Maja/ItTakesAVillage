...
namespace ItTakesAVillage.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserStore<ItTakesAVillageUser> _userStore;
        private readonly IUserEmailStore<ItTakesAVillageUser> _emailStore;
        private readonly ILogger<RegisterModel> _logger;
        private readonly IEmailSender _emailSender;

        public RegisterModel(
            UserManager<ItTakesAVillageUser> userManager,
            IUserStore<ItTakesAVillageUser> userStore,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ItTakesAVillageUser
                {
        ...
        private IUserEmailStore<ItTakesAVillageUser> GetEmailStore()
        {
            ...
            return (IUserEmailStore<ItTakesAVillageUser>)_userStore;
        }
    }
}
