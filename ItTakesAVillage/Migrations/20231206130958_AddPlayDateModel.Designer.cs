...
namespace ItTakesAVillage.Migrations
{
    ...
    [Migration("20231206130958_AddPlayDateModel")]
    partial class AddPlayDateModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItTakesAVillage.Models.PlayDate", b =>
                {
                    b.HasBaseType("ItTakesAVillage.Models.BaseEvent");
                    ...
                    b.Property<string>("InvitedChildName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("Events", t =>
                        {
                            t.Property("Location")
                                .HasColumnName("PlayDate_Location");
                        });
            ...
            modelBuilder.Entity("ItTakesAVillage.Models.UserGroup", b =>
                {
                    b.HasOne("ItTakesAVillage.Models.Group", "Group")
                        .WithMany("UserGroups")
